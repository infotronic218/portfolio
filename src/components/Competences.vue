          ...
          <div class="row h-100">
             ...
             <div class="col-sm-6 mt-2">
              ...
              <div class="col-sm-6 mt-2">
                  <div class="card h-100">
                    <div class="card-header bg-c-6">
                       <h6 class="text-white text-uppercase"><strong> Embedded development boards </strong></h6>
                    </div>
                    <div class="card-body">
                       <span class="badge badge-10 m-1 p-2"> Arduino</span>
                       <span class="badge badge-10 m-1 p-2">  ESP8266/ESP32</span>
